...
enum menu_settings_type
{
   ...
   MENU_SETTING_ACTION_YUNSAVESTATE, // MG 保存云存档
   MENU_SETTING_ACTION_YUNLOADSTATE, // MG 加载云存档
   MENU_SETTING_ACTION_YUN_SAVE_SRM_FILE, // MG 保存SRM云存档
   MENU_SETTING_ACTION_YUN_LOAD_SRM_FILE, // MG 加载SRM云存档
