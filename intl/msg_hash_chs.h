...
MSG_HASH(MENU_ENUM_LABEL_VALUE_LOAD_STATE,
      "即时读档")
MSG_HASH(MENU_ENUM_LABEL_VALUE_YUN_LOAD_STATE,
      "读取云存档")
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_NETWORK_ON_DEMAND_THUMBNAILS,
      "自动下载游戏缩略图")
MSG_HASH(MENU_ENUM_LABEL_VALUE_NETWORK_ON_DEMAND_YUNSAVESTATE,
      "自动保存云存档")
MSG_HASH(MENU_ENUM_SUBLABEL_NETWORK_ON_DEMAND_THUMBNAILS,
      "自动下载游戏缩略图，XMB界面会有性能损耗")
MSG_HASH(MENU_ENUM_SUBLABEL_NETWORK_ON_DEMAND_YUNSAVESTATE,
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_ADD_TO_FAVORITES_PLAYLIST,
      "添加到收藏")
MSG_HASH(MENU_ENUM_LABEL_VALUE_DOWNLOAD_PL_ENTRY_THUMBNAILS,
      "下载缩略图")
MSG_HASH(MENU_ENUM_SUBLABEL_DOWNLOAD_PL_ENTRY_THUMBNAILS,
      "下载当前游戏的缩略图，标题、游戏截图、包装盒等")
MSG_HASH(MENU_ENUM_LABEL_VALUE_DOWNLOAD_PL_ENTRY_ROM,
      "下载游戏")
MSG_HASH(MENU_ENUM_SUBLABEL_DOWNLOAD_PL_ENTRY_ROM,
      "下载当前游戏")
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_UPDATE_ASSETS,
      "更新资源")
MSG_HASH(MENU_ENUM_LABEL_VALUE_UPDATE_SYSTEMS,
      "更新BIOS文件")
MSG_HASH(MENU_ENUM_LABEL_VALUE_UPDATE_PLAYLISTS,
      "更新游戏列表")
...
MSG_HASH(MSG_ERROR_SAVING_SHADER_PRESET,
      "保存预设渲染器文件时出现错误。")
MSG_HASH(MSG_ERROR_TASK_FAILED,
      "任务失败")
