...
MSG_HASH(MENU_ENUM_LABEL_VALUE_TWITCH_STREAM_KEY,
		"Twitch 直播密钥")
MSG_HASH(MENU_ENUM_LABEL_VALUE_RETROGAME_ALLINONE_USERNAME,
		"魔改账号")
MSG_HASH(MENU_ENUM_LABEL_VALUE_RETROGAME_ALLINONE_PASSWORD,
		"魔改邀请码")
MSG_HASH(MENU_ENUM_LABEL_VALUE_RETROGAME_ALLINONE_MCODE,
		"魔改机器码")
