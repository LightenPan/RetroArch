...
- NETPLAY/RELAY: Fix the ¡°spectator¡± bug when using the relay server ¨C When a player switches into the spectator mode (pressing ¡°i¡±) while using the relay server, all players will disconnect.
