...
struct content_playlist
{
    ...
    // MG 新增图标
    size_t last_select_ptr; // 当前选择的游戏列表项
};
typedef struct content_playlist playlist_t;
...
// MG 设置列表当前位置
void playlist_set_last_select_ptr(playlist_t *playlist, size_t select_ptr); // ���浱ǰ�б�ѡ����б���
