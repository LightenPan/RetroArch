...
enum msg_hash_enums
{
   ...
   MENU_LABEL(DOWNLOAD_PL_ENTRY_ROM),
   ...
   MENU_LABEL(UPDATE_SYSTEMS), // 更新BIOS
   MENU_LABEL(UPDATE_PLAYLISTS), // 更新游戏列表
   ...
   MENU_LABEL(YUN_SAVE_STATE), // MG 云存档
   MENU_LABEL(YUN_LOAD_STATE),
   MENU_LABEL(YUN_SAVE_SRM_FILE), // MG SRM云存档
   MENU_LABEL(YUN_LOAD_SRM_FILE),
   ...
   MENU_LABEL(NETWORK_ON_DEMAND_YUNSAVESTATE),
   ...
   MENU_LABEL(CORE_UPDATER_PLAYLISTS), // 锟斤拷锟斤拷锟斤拷戏锟叫憋拷
   ...
   MENU_LABEL(RETROGAME_ALLINONE_USERNAME),
   MENU_LABEL(RETROGAME_ALLINONE_PASSWORD),
   MENU_LABEL(RETROGAME_ALLINONE_MCODE),
   ...
   MENU_ENUM_LABEL_CB_CORE_ROM_DOWNLOAD,
   MENU_ENUM_LABEL_CB_CORE_UPDATER_DOWNLOAD,
   MENU_ENUM_LABEL_CB_CORE_UPDATER_LIST,
   MENU_ENUM_LABEL_CB_CORE_UPDATER_PLAYLISTS,
   ...
   MENU_ENUM_LABEL_CB_UPDATE_SYSTEMS, // 更新BIOS
   ...
   MENU_ENUM_LABEL_CB_UPDATE_PLAYLISTS, // 更新游戏列表
   MENU_ENUM_LABEL_CB_DISCORD_AVATAR,
   MENU_ENUM_LABEL_CB_SINGLE_THUMBNAIL,
   MENU_ENUM_LABEL_CB_SINGLE_ROM,
   MENU_ENUM_LABEL_CB_SINGLE_ZIPROM,
